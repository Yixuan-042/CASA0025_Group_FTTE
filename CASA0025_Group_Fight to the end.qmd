...
Model Construction: Employ Random Forest with CO2 emissions as the dependent variable and the rest of data as independent variables. The model is constructed for the six urban areas in the central Guangzhou by conducting regression analysis after screening the independent variables by colinearity.
